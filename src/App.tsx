      ...
      <div className="mx-auto max-w-2xl bg-white rounded-md shadow p-4 space-y-2 divide-y">
        ...
        <div className="space-y-2">
          ...
          <div className="flex space-x-2 items-center">
            <img className="w-12 h-12 rounded-full" src="/profileImages/magikarp-79778.jpg"></img>
            <span className='font-semibold text-lg'>Nadtaphong Jandaboot 630610743</span>
          </div>

          {/* status message */}
          <p>Quiz ง่ายจังเลยครับ ขอยากๆ กว่านี้ได้ไหม #261207</p>
